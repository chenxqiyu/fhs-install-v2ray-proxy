...
# https://ghproxy.com/https://github.com/v2fly/fhs-install-v2ray

# The URL of the script is:
# https://raw.githubusercontent.com/v2fly/fhs-install-v2ray/master/install-release.sh

# If the script executes incorrectly, go to:
# https://ghproxy.com/https://github.com/v2fly/fhs-install-v2ray/issues
...
identify_the_operating_system_and_architecture() {
  if [[ "$(uname)" == 'Linux' ]]; then
    ...
    ### Refer: https://ghproxy.com/https://github.com/v2fly/fhs-install-v2ray/issues/84#issuecomment-688574989
